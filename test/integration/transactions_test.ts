...
describe("API Server Posting Transactions", () => {
  ...
  describe("POST /api/v1/boost/jobs", () => {
    ...
    it.skip("should accept a confirmed valid boost job transaction and index it", async() => {
    ...
    it.skip("should accept an un-confirmed, new but valid boost job transaction and index it", async() => {
  ...
  describe("GET /api/v1/boost/jobs/{txid}", () => {
    ...
    it.skip("should return the raw job script and the job json", async () => {
